...
response=$(curl -s -X POST http://localhost:8080/new_pipeline --fail-with-body -H 'Content-Type: application/json' -d '{"project_id":'$1',"project_version":'$2',"config_id":'$3',"config_version":'$4'}')
