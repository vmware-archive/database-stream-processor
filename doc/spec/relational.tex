...
Set intersection is a special case of join.  It follows that set intersection is bilinear,
...
TODO.\mihai{Add there a moderately complicated SQL query and show its incremental circuit.}
