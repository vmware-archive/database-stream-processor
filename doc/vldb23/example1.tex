\subsection{Incrementalizing a relational query}\label{sec:relational-example}
...
first rule~\ref{prop-distinct-once}:
...
From rule~\ref{prop-distinct-delay} we get:
...
for each new input is proportional to the size of change.
