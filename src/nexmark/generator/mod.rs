...
pub struct NexmarkGenerator<R: Rng> {
    ...
    /// The count of the next event for this generator.
    // TODO: Rename to next_event_number - no, that's a fn already
    // current_event_count
    // Or use it as it appears to be intended - always 0 and monotonic?
    // So max_events would be divided by the number of generators to split.
