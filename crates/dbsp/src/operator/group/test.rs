...
proptest! {
    #[test]
    fn test_group_ops(trace in input_trace(5, 1_000, 200, 20)) {
        let (mut dbsp, (input_handle, topk_asc_handle, topk_desc_handle)) = Runtime::init_circuit(4, |circuit| test_circuit(circuit)).unwrap();
